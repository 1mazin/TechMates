  ...
  return (
    ...
    <div class="container px-5 py-1 mx-auto">
      <div class="flex flex-wrap md:text-left text-center order-first">
        <div class="lg:w-1/4 md:w-1/2 w-full px-24">
        ...
        <div class="lg:w-1/4 md:w-1/2 w-full px-24">
          <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">HACKATHON</h2>
          <nav class="list-none mb-10">
            <li>
              <a class="text-gray-600 hover:text-gray-800">First Link</a>
            </li>
        ...
        <div class="lg:w-1/4 md:w-1/2 w-full px-24">
          <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">PEERS</h2>
          <nav class="list-none mb-10">
            <li>
              <a class="text-gray-600 hover:text-gray-800">First Link</a>
            </li>
        ...
        <div class="lg:w-1/4 md:w-1/2 w-full px-1">
          ...
          <p class="text-gray-500 text-sm mt-2 md:text-left text-center">Get weekly updates of hackathons 
    ...
    <div class="bg-gray-100">
      <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
        <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
          ...
          <span class="ml-3 text-xl">Techamtes</span>
        </a>
        <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2023 Techmates
